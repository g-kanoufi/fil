...
final class LeadStaffCreateTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_franchisor_can_create_lead(): void
    {
    ...
    public function test_lead_owner_can_update_custom_fields(): void
    {
        $user = User::factory()->create();
